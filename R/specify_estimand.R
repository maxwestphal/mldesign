...
#'
#' @param ... (character | mldesign_constraint | mldesign_constraints) \cr
...
#' @param constraints (mldesign_constraints) \cr a \code{mlguide_constraints} object (created with \code{\link{cc}}),
