...
Let's use the convenience function `get_mlr3_predictions`
...
From here, we can calculate usual metrics of interest, e.g. the area under the ROC curve (AUC).

```{r}
data_benchmark <- 
  predictions %>% 
  derive_metrics(splits = splits, 
...
```{r}
# TODO: visualize outer
```



```{r}
# TODO: compare inner and outer for subset=TRUE
```
